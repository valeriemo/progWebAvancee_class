     ...
     <nav class="bg-white border-gray-200 dark:bg-secondary">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-secondary dark:border-gray-700">
          <li>
            <!-- pour éviter les refresh du page, on utilise le composant <router-link> au lieu de <a> -->
          ...
          <li>
            <router-link to="/add-product" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Add product</router-link>
          </li>
        </ul>
      </div>
      </div>
